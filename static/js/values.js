...
value('tableOfContents', [{
    ...
    'id': 'concurrency',
    'title': 'Паралелизам',
    'description': '<p>У језгру Го језика се налази подршка за паралелну обраду података. </p><p>Овај одељак објашњава горутине и канале, и како се ове две ствари користе за спровођење различитих шаблона парарелне обраде података.</p>',
    'lessons': ['concurrency']
}]).
